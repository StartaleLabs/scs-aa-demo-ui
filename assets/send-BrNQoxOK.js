import{i as f,a as w,d as I,e as x,o as H,I as l,x as u,r as z,m as W,R as g,N as L,J as q,S as B,f as F,A as M,W as Y}from"./index-jgQLEoCx.js";import{n as d,r as c,c as m,U as b,o as J}from"./if-defined-ByNRz2cX.js";import"./index-DzGXq4_5.js";import"./index-kpgGDNAp.js";import{e as O,n as D}from"./ref-Cy49JFg5.js";import{n as K,s as G}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-RF9PomK5.js";import{S as Q}from"./index-Dpkk8WeU.js";import"./index-BBsDIx9H.js";import"./index-DF7MqdsM.js";import"./index-ClTsYsva.js";import"./index-DwpbXCBp.js";import"./index--lqpBvBf.js";import"./index.es-AhyaNcPu.js";import"./index-BZ_QF9hs.js";const X=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var j=function(s,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,n);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(t=(r<3?o(t):r>3?o(e,i,t):o(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let C=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var e;return(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
    ...
    /> `}dispatchInputChangeEvent(e){var n,r;const i=e.data;if(i&&((n=this.inputElementRef)!=null&&n.value))if(i===","){const t=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=t,this.value=`${this.value}${t}`}else K.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(G,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:(r=this.inputElementRef.value)==null?void 0:r.value,bubbles:!0,composed:!0}))}};C.styles=[z,W,Z];j([d({type:Boolean})],C.prototype,"disabled",void 0);j([d({type:String})],C.prototype,"value",void 0);j([d({type:String})],C.prototype,"placeholder",void 0);C=j([m("wui-input-amount")],C);const ee=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
