import{G as ie,y as se,K as Z,F as K,L as F,e as A,c as oe,A as $,P as ne,z as ae,B as ce,i as R,a as y,x as c,Q as L,U as C,O as D,M as _,J as le,f as ee,W as te,R as E,d as q,b as V,o as ue,S as M,T as de}from"./index-jgQLEoCx.js";import{n as p,c as g,o as h,r as d}from"./if-defined-ByNRz2cX.js";import{D as pe,T as me}from"./index-DrGO393Z.js";import"./index-kpgGDNAp.js";import"./index-DwpbXCBp.js";import"./index-BZ_QF9hs.js";import"./index-C6HcyIaL.js";import{O as Y}from"./index-D49BtKZ-.js";import"./index-jBv-7Ev_.js";import"./index-RF9PomK5.js";import"./index-DzGXq4_5.js";import"./index-BwkLHZxl.js";import"./index-BBsDIx9H.js";import"./index--lqpBvBf.js";import"./index.es-AhyaNcPu.js";import"./index-CY6mobPn.js";import"./ref-Cy49JFg5.js";import"./ConstantsUtil-Dmg8YACJ.js";const j={id:"2b92315d-eab7-5bef-84fa-089a131333f5",name:"USD Coin",symbol:"USDC",networks:[{name:"ethereum-mainnet",display_name:"Ethereum",chain_id:"1",contract_address:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"},{name:"polygon-mainnet",display_name:"Polygon",chain_id:"137",contract_address:"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"}]},G={id:"USD",payment_method_limits:[{id:"card",min:"10.00",max:"7500.00"},{id:"ach_bank_account",min:"10.00",max:"25000.00"}]},he={providers:Z,selectedProvider:null,error:null,purchaseCurrency:j,paymentCurrency:G,purchaseCurrencies:[j],paymentCurrencies:[],quotesLoading:!1},u=se(he),fe={state:u,subscribe(s){return ce(u,()=>s(u))},subscribeKey(s,e){return ae(u,s,e)},setSelectedProvider(s){if(s&&s.name==="meld"){const e=A.state.activeChain===oe.CHAIN.SOLANA?"SOL":"USDC",t=$.state.address??"",i=new URL(s.url);i.searchParams.append("publicKey",ne),i.searchParams.append("destinationCurrencyCode",e),i.searchParams.append("walletAddress",t),s.url=i.toString()}u.selectedProvider=s},setPurchaseCurrency(s){u.purchaseCurrency=s},setPaymentCurrency(s){u.paymentCurrency=s},setPurchaseAmount(s){l.state.purchaseAmount=s},setPaymentAmount(s){l.state.paymentAmount=s},async getAvailableCurrencies(){const s=await K.getOnrampOptions();u.purchaseCurrencies=s.purchaseCurrencies,u.paymentCurrencies=s.paymentCurrencies,u.paymentCurrency=s.paymentCurrencies[0]||G,u.purchaseCurrency=s.purchaseCurrencies[0]||j,await F.fetchCurrencyImages(s.paymentCurrencies.map(e=>e.id)),await F.fetchTokenImages(s.purchaseCurrencies.map(e=>e.symbol))},async getQuote(){var s,e;u.quotesLoading=!0;try{const t=await K.getOnrampQuote({purchaseCurrency:u.purchaseCurrency,paymentCurrency:u.paymentCurrency,amount:((s=u.paymentAmount)==null?void 0:s.toString())||"0",network:(e=u.purchaseCurrency)==null?void 0:e.symbol});return u.quotesLoading=!1,u.purchaseAmount=Number(t==null?void 0:t.purchaseAmount.amount),t}catch(t){return u.error=t.message,u.quotesLoading=!1,null}finally{u.quotesLoading=!1}},resetState(){u.providers=Z,u.selectedProvider=null,u.error=null,u.purchaseCurrency=j,u.paymentCurrency=G,u.purchaseCurrencies=[j],u.paymentCurrencies=[],u.paymentAmount=void 0,u.purchaseAmount=void 0,u.quotesLoading=!1}},l=ie(fe),we=R`
  :host {
    width: 100%;
  }
...
`;var B=function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(r=(o<3?n(r):o>3?n(e,t,r):n(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};const ge=7;let O=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=l.state.selectedProvider,this.loading=!1,this.coinbaseTransactions=L.state.coinbaseTransactions,this.tokenImages=C.state.tokenImages,this.unsubscribe.push(l.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}),C.subscribeKey("tokenImages",e=>this.tokenImages=e),()=>{clearTimeout(this.refetchTimeout)},L.subscribe(e=>{this.coinbaseTransactions={...e.coinbaseTransactions}})),L.clearCursor(),this.fetchTransactions()}render(){return c`
...
`;var U=function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(r=(o<3?n(r):o>3?n(e,t,r):n(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let T=class extends y{constructor(){var e;super(),this.unsubscribe=[],this.type="Token",this.value=0,this.currencies=[],this.selectedCurrency=(e=this.currencies)==null?void 0:e[0],this.currencyImages=C.state.currencyImages,this.tokenImages=C.state.tokenImages,this.unsubscribe.push(l.subscribeKey("purchaseCurrency",t=>{!t||this.type==="Fiat"||(this.selectedCurrency=this.formatPurchaseCurrency(t))}),l.subscribeKey("paymentCurrency",t=>{!t||this.type==="Token"||(this.selectedCurrency=this.formatPaymentCurrency(t))}),l.subscribe(t=>{this.type==="Fiat"?this.currencies=t.purchaseCurrencies.map(this.formatPurchaseCurrency):this.currencies=t.paymentCurrencies.map(this.formatPaymentCurrency)}),C.subscribe(t=>{this.currencyImages={...t.currencyImages},this.tokenImages={...t.tokenImages}}))}firstUpdated(){l.getAvailableCurrencies()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var i;const e=((i=this.selectedCurrency)==null?void 0:i.symbol)||"",t=this.currencyImages[e]||this.tokenImages[e];return c`<wui-input-text type="number" size="lg" value=${this.value}>
    ...
    </wui-input-text>`}formatPaymentCurrency(e){return{name:e.id,symbol:e.id}}formatPurchaseCurrency(e){return{name:e.name,symbol:e.symbol}}};T.styles=Pe;U([p({type:String})],T.prototype,"type",void 0);U([p({type:Number})],T.prototype,"value",void 0);U([d()],T.prototype,"currencies",void 0);U([d()],T.prototype,"selectedCurrency",void 0);U([d()],T.prototype,"currencyImages",void 0);U([d()],T.prototype,"tokenImages",void 0);T=U([g("w3m-onramp-input")],T);const Ie=R`
  :host > wui-flex {
    width: 100%;
    max-width: 360px;
  }
